...
ui.reset_main_ui = function(player_index)
    storage.main_elements[player_index].vote_frame.visible = false
    storage.main_elements[player_index].reset_button.visible = true
end
...
ui.add_gui_to_player = function(player_index)
  ...
  storage.main_elements[player_index].main_dialog = player.gui.left.add{type="frame", visible=false, name="main_dialog", direction="vertical"}
  storage.main_elements[player_index].main_dialog.caption = {"sw.main_dialog_caption"}
  storage.main_elements[player_index].main_dialog_inner_frame = storage.main_elements[player_index].main_dialog.add{type="frame", style="inside_shallow_frame_with_padding",name="game_info", direction="vertical"}
  local time_row = storage.main_elements[player_index].main_dialog_inner_frame.add{type="flow"}
  time_row.add{type="label", caption={"sw.time"}, name="time_label"}
  storage.main_elements[player_index].time_value = time_row.add{type="label", caption="", name="time_value"}

  local evo_row = storage.main_elements[player_index].main_dialog_inner_frame.add{type="flow"}
  evo_row.style.horizontal_spacing = 78
  local evo_label = evo_row.add{type="label", caption={"sw.evo"}, name="evo"}
  storage.main_elements[player_index].evo_value = evo_row.add{type="label", caption="", name="evo_value"}
  storage.main_elements[player_index].reset_button = storage.main_elements[player_index].main_dialog_inner_frame.add{type="button", caption={"sw.vote_reset"}, name="reset_button"}
  storage.main_elements[player_index].reset_button.style.width = 0
  storage.main_elements[player_index].reset_button.style.top_margin = 10
  storage.main_elements[player_index].reset_button.style.vertically_stretchable = true

  storage.main_elements[player_index].vote_frame = storage.main_elements[player_index].main_dialog.add{type="frame", direction="vertical", visible=false, style="inside_shallow_frame_with_padding"}
  storage.main_elements[player_index].vote_frame.style.top_margin = 10
  storage.main_elements[player_index].vote_label = storage.main_elements[player_index].vote_frame.add{type="label", caption={"sw.vote_label"}}
  storage.main_elements[player_index].vote_results = storage.main_elements[player_index].vote_frame.add{type="label", caption=""}
  storage.main_elements[player_index].vote_flow= storage.main_elements[player_index].vote_frame.add{type="frame", style="invisible_frame"}
  storage.main_elements[player_index].yes_button = storage.main_elements[player_index].vote_flow.add{type="button", caption={"sw.yes_button"}, name="yes_button"}
  storage.main_elements[player_index].abstain_button = storage.main_elements[player_index].vote_flow.add{type="button", caption={"sw.abstain_button"}, name="abstain_button"}
  storage.main_elements[player_index].no_button = storage.main_elements[player_index].vote_flow.add{type="button", caption={"sw.no_button"}, name="no_button"}
  storage.main_elements[player_index].yes_button.style.top_margin = 10
  storage.main_elements[player_index].yes_button.style.horizontally_stretchable = true
  storage.main_elements[player_index].abstain_button.style.top_margin = 10
  storage.main_elements[player_index].abstain_button.style.horizontally_stretchable = true
  storage.main_elements[player_index].no_button.style.top_margin = 10
  storage.main_elements[player_index].no_button.style.horizontally_stretchable = true

  -- Lobby modal for setting map settings and starting the game.
  storage.main_elements[player_index].lobby_modal = player.gui.screen.add{type="frame", visible=true, name="lobby_modal", caption={"sw.lobby"}, direction="vertical"}
  storage.main_elements[player_index].lobby_modal.auto_center = true

  local inner_frame = storage.main_elements[player_index].lobby_modal.add{type="frame", style="inside_deep_frame", name="game_info", direction="vertical"}
  ...
  storage.main_elements[player_index].biter_regen_checkbox = settings_content.add{type="checkbox", state=storage.current_settings.biter_regen, caption="Biter Regen", name="biter_regen_checkbox"}
  storage.main_elements[player_index].biter_regen_checkbox.tooltip = {"sw.biter_regen_tooltip"}
  storage.main_elements[player_index].pitch_black_checkbox = settings_content.add{type="checkbox", state=storage.current_settings.pitch_black, caption="Pitch Black Night", name="pitch_black_checkbox"}
  storage.main_elements[player_index].pitch_black_checkbox.tooltip = {"sw.pitch_black_tooltip"}
  storage.main_elements[player_index].shallow_water_checkbox = settings_content.add{type="checkbox", state=storage.current_settings.shallow_water, caption="Shallow Water", name="shallow_water_checkbox"}
  storage.main_elements[player_index].shallow_water_checkbox.tooltip = {"sw.shallow_water_tooltip"}
  storage.main_elements[player_index].robots_checkbox = settings_content.add{type="checkbox", state=storage.current_settings.robots, caption="Construction Robot Start", name="robots_checkbox"}
  storage.main_elements[player_index].robots_checkbox .tooltip = {"sw.robots_tooltip"}
  ...
  storage.main_elements[player_index].iron_size_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.iron_size}
  storage.main_elements[player_index].iron_frequency_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.iron_frequency}
  storage.main_elements[player_index].iron_richness_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.iron_richness}

  map_settings_content.add{type="label", caption="Copper", name="copper_label"}
  storage.main_elements[player_index].copper_size_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.copper_size}
  storage.main_elements[player_index].copper_frequency_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.copper_frequency}
  storage.main_elements[player_index].copper_richness_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.copper_richness}

  map_settings_content.add{type="label", caption="Coal", name="coal_label"}
  storage.main_elements[player_index].coal_size_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.coal_size}
  storage.main_elements[player_index].coal_frequency_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.coal_frequency}
  storage.main_elements[player_index].coal_richness_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.coal_richness}

  map_settings_content.add{type="label", caption="Stone", name="stone_label"}
  storage.main_elements[player_index].stone_size_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.stone_size}
  storage.main_elements[player_index].stone_frequency_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.stone_frequency}
  storage.main_elements[player_index].stone_richness_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.stone_richness}

  map_settings_content.add{type="label", caption="Oil", name="oil_label"}
  storage.main_elements[player_index].oil_size_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.oil_size}
  storage.main_elements[player_index].oil_frequency_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.oil_frequency}
  storage.main_elements[player_index].oil_richness_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.oil_richness}

  map_settings_content.add{type="label", caption="Uranium", name="uranium_label"}
  storage.main_elements[player_index].uranium_size_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.uranium_size}
  storage.main_elements[player_index].uranium_frequency_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.uranium_frequency}
  storage.main_elements[player_index].uranium_richness_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.uranium_richness}

  map_settings_content.add{type="label", caption="Trees", name="trees_label"}
  storage.main_elements[player_index].trees_size_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.trees_size}
  storage.main_elements[player_index].trees_frequency_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.trees_frequency}
  storage.main_elements[player_index].trees_richness_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.trees_richness}

  map_settings_content.add{type="label", caption="Biters", name="biter_label"}
  storage.main_elements[player_index].biter_size_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.biter_size}
  storage.main_elements[player_index].biter_frequency_slider = map_settings_content.add{type="textfield", numeric=true, allow_decimal=true, text=storage.current_settings.biter_frequency}
  ...
  storage.main_elements[player_index].players_content = tabbed_pane.add{type="flow", name="players_content", direction="vertical"}
  storage.main_elements[player_index].players_content.style.padding = 5;
  ...
  tabbed_pane.add_tab(players, storage.main_elements[player_index].players_content)
  tabbed_pane.selected_tab_index = 1
  local bottom_buttons_flow = storage.main_elements[player_index].lobby_modal.add{type="flow"}
  storage.main_elements[player_index].preview_button = bottom_buttons_flow.add{type="button", caption={"sw.preview"}, name="preview_button"}
  storage.main_elements[player_index].start_button = bottom_buttons_flow.add{type="button", caption={"sw.start_game"}, name="start_button"}
  storage.main_elements[player_index].start_button.style.width = 0
  storage.main_elements[player_index].start_button.style.top_margin = 5
  storage.main_elements[player_index].start_button.style.horizontally_stretchable = true

  storage.main_elements[player_index].preview_button.style.width = 0
  storage.main_elements[player_index].preview_button.style.top_margin = 5
  storage.main_elements[player_index].preview_button.style.horizontally_stretchable = true

  if storage.game_state == "in_game" then
   storage.main_elements[player_index].lobby_modal.visible = false 
  end
end
...
script.on_event(defines.events.on_gui_checked_state_changed, 
  function(event)
    ...
    elseif event.element.name == "robots_checkbox" then
      ...
      for _, player in pairs(game.connected_players) do 
        storage.main_elements[player.index].robots_checkbox.state = event.element.state
      end
